...
#' @noRd
#'
validate_cols <- function(.data, cols_req, call = rlang::caller_env() # this argument is letting it know to mention the function that called the validate function when it throws the error
                          ) {
