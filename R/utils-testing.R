local_warn_partial_match <- function(.local_envir = parent.frame()) {
  ...
  withr::local_options(
    ...
    .local_envir = .local_envir # this is a little special here, normally you
    # end when this function ends, but this one is meant to last the duration of the calling function
  )
